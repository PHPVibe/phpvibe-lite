<?php 	
if(!class_exists('vibe_clean_xss'))
{
/**
 * Wrapper Class for All input data ( POST, GET, COOKIE) derived from CodeIgniter's Input Class
 * Dont trust $_GET, $_POST and $_COOKIE variables!
  * most functions in this class was a compilation of 
 * XSS security function from CodeIgniter and http://ha.ckers.org 
 */
class vibe_clean_xss {
